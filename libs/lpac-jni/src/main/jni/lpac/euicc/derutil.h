...
/* Returns 0 for a node, 1 at the exact end of the buffer, and -1 for malformed input. */
...
/* Validate canonical UTF-8 without embedded NULs and enforce a code-point cap. */
